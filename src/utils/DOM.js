...
export const $$ = (s, o = document) => o.querySelectorAll(s)

export const wrap = (el, className, node = 'div') => {
...
export const bgParallax = (el, speed = 3) => {
  ...
  const tick = () => {
    const x = el.getBoundingClientRect().top / speed
